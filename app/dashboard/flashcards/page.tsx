                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                        <div className="bg-emerald-500 rounded-2xl p-3 shadow-lg shadow-emerald-500/20">
                            <div className="flex items-center gap-2 mb-1.5">
                                ...
                                <div>
                                    <div className="text-xl font-black text-white leading-none">{overallMastered}</div>
                                    <div className="text-[10px] font-medium text-emerald-100 uppercase tracking-wider mt-0.5">Mastered</div>
                                </div>
                            </div>
                        ...
                        <div className="bg-amber-500 rounded-2xl p-3 shadow-lg shadow-amber-500/20">
                            <div className="flex items-center gap-2">
                                <div className="w-9 h-9 rounded-lg bg-white/20 flex items-center justify-center backdrop-blur-sm">
                                    <Books weight="fill" className="w-4 h-4 text-white" />
                                </div>
                                <div>
                                    <div className="text-xl font-black text-white leading-none">{overallLearning}</div>
                                    <div className="text-[10px] font-medium text-amber-100 uppercase tracking-wider mt-0.5">Learning</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-blue-500 rounded-2xl p-3 shadow-lg shadow-blue-500/20">
                            <div className="flex items-center gap-2">
                                ...
                                <div>
                                    <div className="text-xl font-black text-white leading-none">{overallNew}</div>
                                    <div className="text-[10px] font-medium text-blue-100 uppercase tracking-wider mt-0.5">New</div>
                                </div>
                            </div>
                        </div>

                        <div className="bg-red-500 rounded-2xl p-3 shadow-lg shadow-red-500/20">
                            <div className="flex items-center gap-2">
                                <div className="w-9 h-9 rounded-lg bg-white/20 flex items-center justify-center backdrop-blur-sm">
                                    <Timer weight="fill" className="w-4 h-4 text-white" />
                                </div>
                                <div>
                                    <div className="text-xl font-black text-white leading-none">{overallDue}</div>
                                    <div className="text-[10px] font-medium text-red-100 uppercase tracking-wider mt-0.5">Due Review</div>
                                </div>
                            </div>
                        </div>
                    </div>
