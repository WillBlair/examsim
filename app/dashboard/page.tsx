          ...
          <section className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:items-stretch">
            ...
            <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <Link href="/dashboard/new" className="group block h-full">
                <div className="bg-emerald-50 rounded-md p-2.5 border-2 border-zinc-900 shadow-none transition-all duration-300 hover:shadow-[4px_4px_0px_0px_rgba(24,24,27,1)] hover:-translate-y-1 h-full flex flex-col justify-between relative overflow-hidden">
              ...
              <Link href="/dashboard/flashcards/new" className="group block h-full">
                <div className="bg-amber-50 rounded-md p-2.5 border-2 border-zinc-900 shadow-none transition-all duration-300 hover:shadow-[4px_4px_0px_0px_rgba(24,24,27,1)] hover:-translate-y-1 h-full flex flex-col justify-between relative overflow-hidden">
