...
import { Plus, ArrowRight, TrendUp, Lightning, CaretRight, Calendar, Scroll } from "@phosphor-icons/react/dist/ssr";
import { db } from "@/db";
        ...
        <>
          ...
          <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link href="/dashboard/new" className="group md:col-span-2 relative">
                <div className="h-full min-h-[220px] bg-white rounded-lg p-8 relative overflow-hidden transition-all duration-300 border-2 border-zinc-900 shadow-neo hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none">
                    {/* Background Effects */}
                    ...
                    <div className="relative z-10 flex flex-col justify-between h-full">
                        <div className="space-y-4">
                            ...
                            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-sm bg-accent-purple/10 text-accent-purple text-xs font-bold tracking-wide uppercase border border-accent-purple/20 w-fit group-hover:bg-accent-purple !group-hover:text-white group-hover:border-zinc-900 transition-colors duration-300">
                                ...
                                <span className="!group-hover:text-white transition-colors duration-300">Create New</span>
                            </div>
            ...
            <div className="bg-white rounded-lg border-2 border-zinc-900 shadow-neo p-6 relative overflow-hidden flex flex-col justify-between h-full transition-all duration-300 group hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none">
                ...
                <div className="relative z-10 mt-6 pt-4 border-t border-dashed border-zinc-200 group-hover:border-zinc-900/20 transition-colors">
                    ...
                    <div className="h-2 w-full bg-zinc-100 rounded-sm overflow-hidden border border-transparent group-hover:border-zinc-200">
                         <div 
                    ...
                    <p className="text-[10px] text-zinc-400 mt-2 text-center group-hover:text-zinc-600">
