...
export function Footer() {
  return (
    <footer className="bg-transparent border-t border-zinc-200 text-zinc-600 py-12">
         ...
         <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <div className="flex items-center gap-4">
              <Link href="#" className="p-2 text-zinc-400 hover:text-zinc-900 transition-colors">
                <AppIcon name="Twitter" className="w-5 h-5" />
              </Link>
              <Link href="#" className="p-2 text-zinc-400 hover:text-zinc-900 transition-colors">
                <AppIcon name="GitHub" className="w-5 h-5" />
              </Link>
            </div>
         </div>
         
         <div className="text-center md:text-left mt-12 flex flex-col md:flex-row justify-between items-center text-xs text-zinc-400 font-medium">
