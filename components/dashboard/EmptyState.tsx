    ...
    >
      <div className="relative mb-6">
        <motion.div
          ...
          className="relative w-16 h-16 rounded-2xl bg-brand-orange text-white flex items-center justify-center shadow-lg shadow-orange-500/20"
        >
          {icon || <FileText className="w-8 h-8" weight="fill" />}
        </motion.div>
      </div>
      ...
      {actionHref && (
        ...
        >
          <Link href={actionHref}>
            <Button className="h-11 px-6 rounded-xl bg-zinc-900 hover:bg-zinc-800 text-white font-bold shadow-lg shadow-zinc-900/10 hover:shadow-xl hover:-translate-y-0.5 transition-all gap-2">
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-white border border-zinc-200 shadow-sm">
      ...
      <EmptyState
        ...
        actionHref="/dashboard/new"
        icon={<Rocket className="w-8 h-8" weight="fill" />}
      />
    </div>
  );
}
...
export function ExamsEmptyState() {
  return (
    <EmptyState
      ...
      actionHref="/dashboard/new"
      icon={<Sparkle className="w-8 h-8" weight="fill" />}
    />
  );
}
...
export function ResultsEmptyState() {
  return (
    <EmptyState
      ...
      icon={<BookOpen className="w-8 h-8" weight="fill" />}
    />
  );
}
