...
export function WeakAreas({ weakAreas }: WeakAreasProps) {
  ...
  return (
    <div className="h-full">
      <div className="p-6 rounded-md bg-rose-50 border-2 border-zinc-900 shadow-none transition-all duration-300 hover:shadow-[4px_4px_0px_0px_rgba(24,24,27,1)] hover:-translate-y-1 relative overflow-hidden h-full flex flex-col group">
        {/* Subtle accent */}
