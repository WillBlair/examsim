      ...
      <CardHeader className="pb-0 pt-8 relative z-10">
        <div className="w-full flex flex-col gap-y-3 items-center justify-center">
          <Link href="/" className="flex items-center gap-2 group transition-transform hover:scale-105">
            <div className="w-10 h-10 rounded-lg shadow-md shadow-black/20 overflow-hidden">
              <Image src="/images/examsimlogogreen-removebg-preview.png" alt="ExamSim Logo" width={40} height={40} className="w-full h-full object-cover" />
            </div>
